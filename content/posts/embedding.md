...
It's too early to prescribe solutions, but I do believe that a way to define 'islands' or web components as embeddable and a way to embed sub-trees and components (islands) is needed and as we do that, I think it's time again to think about exposing intents and contracts on sites, pages and components and make them discoverable.
