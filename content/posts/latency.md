...
This was written at the dawn of the web and was later [refined in 2014 for web applications](https://www.nngroup.com/articles/response-times-3-important-limits/#:~:text=Web%2DBased%20Application%20Response%20Time) and I think that it's interesting that streaming of responses has been used as a way to keep people engaged. Yes, streaming of responses has been an interesting hack to improve the perception of speed, and yes, fundamentally these models are doing trillions upon trillions of calculations to get us an answer, but it doesn't change the fact that the underlying model is slow to generate the content,
