...
Heck, if we get this right even us mere mortal sacks of fluid could maybe even devise a special type of link `intent:find+a+book+about+raising+chickens` that we can click on and have the same look up happen that we granted to the machines first...
